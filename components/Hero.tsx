    ...
    <div className="pt-[3.25rem] px-[3rem] flex flex-col gap-[3rem] ">
      ...
      <div className="flex flex-col sm:flex-row p-6 gap-8 ">
        ...
        <div className="w-40% mx-auto my-0 flex flex-col gap-3 justify-center  p-5 rounded-xl shadow-lg bg-[white]/40 backdrop-blur-[150px]">
          ...
          <p>
            CodeBird's online CTF competition is on{" "}
            <span className="text-indigo-700 font-extrabold">07/07/07</span> at{" "}
            <span className="text-indigo-700 font-extrabold">7:00AM</span> ⏰,
            conducted entirely online 🌐. Open to single players, compete for
            rewards and test your skills 💻
          </p>
        </div>
        <div className="w-40% mx-auto my-0 flex flex-col gap-3 justify-center p-5 rounded-xl shadow-lg bg-[white]/40 backdrop-blur-[150px]">
